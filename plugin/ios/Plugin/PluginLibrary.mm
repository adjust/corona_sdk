...
PluginLibrary::Finalizer( lua_State *L )
{
    ...
    CoronaLuaDeleteRef( L, library->GetSessionTrackingSucceededListener() );
    CoronaLuaDeleteRef( L, library->GetSessionTrackingFailedListener() );
    CoronaLuaDeleteRef( L, library->GetEventTrackingSucceededListener() );
    CoronaLuaDeleteRef( L, library->GetEventTrackingFailedListener() );
...
PluginLibrary::isEnabled( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_IS_ADJUST_ENABLED withMessage:result];
    }
...
PluginLibrary::getIdfa( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_GET_IDFA withMessage:idfa];
    }
...
PluginLibrary::getAttribution( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_GET_ATTRIBUTION withMessage:strDict];
    }
...
PluginLibrary::getAdid( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_GET_ADID withMessage:adid];
    }
...
PluginLibrary::getGoogleAdId( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_GET_GOOGLEADID withMessage:googleAdId];
    }
...
PluginLibrary::getAmazonAdId( lua_State *L )
{
    ...
    if ( CoronaLuaIsListener( L, listenerIndex, "ADJUST" ) )
    {
        ...
        [AdjustSdkDelegate dispatchEvent:L withListener:listener withEventName:EVENT_GET_AMAZONADID withMessage:amazonAdId];
    }
